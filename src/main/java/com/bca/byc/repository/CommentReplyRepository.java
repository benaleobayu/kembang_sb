...
public interface CommentReplyRepository extends JpaRepository<CommentReply, Long> {
    ...
    @Query("SELECT cr " +
            ...
            "JOIN cr.parentComment c " +
            "WHERE c.id = :commentId AND " +
            "cr.isActive = true AND cr.isDeleted = false")
    Page<CommentReply> findListDataCommentUser(@Param("commentId") Long commentId, Pageable pageable);
}
