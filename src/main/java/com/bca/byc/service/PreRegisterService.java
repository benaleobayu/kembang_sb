...
public interface PreRegisterService {
    ...
    ResultPageResponseDTO<PreRegisterIndexElasticResponse> listDataOnElastic(Integer pages, Integer limit, String sortBy, String direction, String keyword, AdminApprovalStatus status, LocalDate startDate, LocalDate endDate);
    ...
    String getCount(Boolean isElastic);
}
