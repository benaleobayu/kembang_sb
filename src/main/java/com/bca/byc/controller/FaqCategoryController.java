...
public class FaqCategoryController {
    ...
    @Operation(summary = "Get List Faq Category", description = "Get List Faq Category")
    @GetMapping
    public ResponseEntity<PaginationCmsResponse<ResultPageResponseDTO<FaqCategoryIndexResponse>>> listDataFaqCategory(
            ...
            @RequestParam(name = "export", required = false) Boolean export // TODO export faq
    ) {
        // response true
    ...
    @Operation(summary = "Get detail Faq Category", description = "Get detail Faq Category")
    @GetMapping("{id}")
    ...
    @Operation(summary = "Create Faq Category", description = "Create Faq Category")
    @PostMapping
    ...
    @Operation(summary = "Update Faq Category", description = "Update Faq Category")
    @PutMapping("{id}")
    ...
    @Operation(summary = "Delete Faq Category", description = "Delete Faq Category")
    @DeleteMapping("{id}")
