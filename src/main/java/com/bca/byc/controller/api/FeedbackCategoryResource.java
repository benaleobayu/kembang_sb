...
public class FeedbackCategoryResource {
    ...
    public ResponseEntity<ApiResponse> getAll() {
        ...
        try {
            return ResponseEntity.ok(new ApiResponse(true, "Successfully found feedback category", service.findAllData()));
    ...
    public ResponseEntity<ApiResponse> getById(@PathVariable("id") Long id) {
        ...
        try {
            FeedbackCategoryModelDTO.FeedbackCategoryDetailResponse item = service.findDataById(id);
            return ResponseEntity.ok(new ApiResponse(true, "Successfully found feedback category", item));
        } catch (BadRequestException e) {
            return ResponseEntity.badRequest().body(new ApiResponse(false, e.getMessage(), null));
        }
    }
