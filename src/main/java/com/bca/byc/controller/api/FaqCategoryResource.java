...
public class FaqCategoryResource {
    ...
    public ResponseEntity<ApiResponse> getAll() {
        ...
        try {
            return ResponseEntity.ok(new ApiResponse(true, "Successfully found Faq Category", service.findAllData()));
    ...
    public ResponseEntity<ApiResponse> getById(@PathVariable("id") Long id) {
        ...
        try {
            ...
            return ResponseEntity.ok(new ApiResponse(true, "Successfully found Faq Category", item));
        } catch (BadRequestException e) {
            return ResponseEntity.badRequest().body(new ApiResponse(false, e.getMessage(), null));
        }
    }
