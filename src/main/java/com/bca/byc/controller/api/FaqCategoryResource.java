...
public class FaqCategoryResource {
    ...
    public ResponseEntity<ApiListResponse> getAll() {
        log.info("GET /api/v1/faq-category endpoint hit");
        try {
            return ResponseEntity.ok(new ApiListResponse(true, "Successfully found Faq Category", service.findAllData()));
    ...
    @PostMapping
    public ResponseEntity<ApiResponse> create(@Valid @ModelAttribute FaqCategoryModelDTO.FaqCategoryCreateRequest item) {
        log.info("POST /api/v1/faq-category endpoint hit");
        try {
            service.saveData(item);
            return ResponseEntity.created(URI.create("/api/v1/faq-category/"))
    ...
    @PutMapping("{id}")
    public ResponseEntity<ApiResponse> update(@PathVariable("id") Long id, @Valid @ModelAttribute FaqCategoryModelDTO.FaqCategoryUpdateRequest item) {
    ...
    public ResponseEntity<ApiResponse> delete(@PathVariable("id") Long id) {
        log.info("DELETE /api/v1/faq-category/{id} endpoint hit");
        try {
