...
public class LoggingAspect {
	...
	@Pointcut("execution(* com.bca.byc.web.*.*(..))")
	private void restAPI() {}
	
	@Pointcut("within(com.bca.byc.web.*)")
	private void withinPointcutExample() {}
	
	@Pointcut("args(com.bca.byc.model.old.PublisherCreateRequestDTO)")
	private void argsPointcutExample() {}
	
	@Pointcut("@args(com.bca.byc.annotation.LogThisArg)")
	private void argsAnnotationPointcutExample() {}
	
	@Pointcut("@annotation(com.bca.byc.annotation.LogThisMethod)")
